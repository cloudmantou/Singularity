...
(function (global) {
  ...
  const en = {
    ...
    "review.subtitle": "Resolve conflicts, entity identity, and similar memories. Every decision is recorded in the audit chain.",
    ...
    "review.ai.batch": "Review 5 with AI",
    "review.ai.batchPending": "Queueing AI review suggestions…",
    "review.ai.batchError": "The AI review batch could not be queued.",
    "review.ai.label": "AI recommendation",
    "review.ai.start": "Ask AI to review",
    ...
    "review.ai.needsHuman": "The reviewer abstained. A human decision is required.",
    "review.ai.modeLabel": "AI mode",
    "review.ai.mode.shadow": "Shadow evaluation",
    "review.ai.mode.suggest": "Suggestions only",
    "review.ai.mode.auto_low_risk": "Low-risk auto",
  ...
  const zh = {
    ...
    "review.kicker": "Knowledge Review",
    "review.title": "知识审核",
    "review.subtitle": "裁决冲突、实体身份和相似记忆。所有决定都会进入审计链。",
    "review.refresh": "刷新",
    "review.queues": "审核队列",
    ...
    "review.ai.batch": "AI 审核 5 项",
    "review.ai.batchPending": "正在加入 AI 审核队列…",
    "review.ai.batchError": "无法创建批量 AI 审核任务。",
    "review.ai.label": "AI 审核建议",
    "review.ai.start": "请 AI 审核",
